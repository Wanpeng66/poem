    ...
    <script>
        $(function () {
            ...
            $("#searchBtn").click(function () {
                ...
                $.get("${pageContext.request.contextPath}/poem/findAllKeywords", {content: content,type:"",author:"",subType:""}, function (result) {
                    createIndex(result.poems,"#div");
                }, "JSON");
            });
            ...
            $(".breadcrumb").on("click","li",(e)=>{
                ...
                let subType = $(".actives").eq(1).text();
                let author = $(".actives").last().text();
                let content = $("#searchText").val();
                $.get("${pageContext.request.contextPath}/poem/findAllKeywords", {content: content,type:type,author:author,subType:subType}, function (result) {
                    createIndex(result.poems,"#div");
                }, "JSON");
            });
        });
