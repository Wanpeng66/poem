...
public class PoemController {
    ...
    public Map<String, Object> findByPage(Integer page, Integer rows) {
        ...
        //查询所有诗词 每个诗中包含所属分类
        List<JpaPoem> poems = poemService.findByPage(page, rows);
        //查询古诗总记录数
    ...
    public Map<String, Object> findAll(String content, String type, String author,String subType) {
        Map<String, Object> map = new HashMap<>();
        ...
        try {
            List<Poem> poems = poemService.findByKeywords(content, type, author,subType);
            map.put("success", true);
            map.put("msg", "查询成功!");
            map.put("poems", poems);
        } catch (Exception e) {
